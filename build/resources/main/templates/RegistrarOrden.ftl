        ...
        <div class="row justify-content-md-center">
            <div class="col-6">
                <div class="card text-dark" style="padding: 20px; background-color: lightgray">
                    <form action="/ordenes/registrar" method="post" enctype="application/x-www-form-urlencoded">
                        <#if articulos?has_content>
                            <div class="form-group mb-2">
                                <label for="codigoArticulo">Art&iacute;culo:</label>
                                <select class="form-select" id="codigoArticulo" name="codigoArticulo" required>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="date" class="form-control" id="fechaRequerida" name="fechaRequerida" required>
                            </div>
                            <div class="form-group mb-2">
                                <label for="cantRequeridaInventario">Cantidad Requerida en Inventario:</label>
                                <input type="cantRequeridaInventario" min="1" class="form-control" id="cantRequeridaInventario" name="cantRequeridaInventario" required>
                            </div>
